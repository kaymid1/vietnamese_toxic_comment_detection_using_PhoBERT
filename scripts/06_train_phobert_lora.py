...
MLFLOW_EXPERIMENT_NAME = get_local_experiment_name("phobert_v2_f1_toxic")
...
PRIMARY_METRIC = os.environ.get("PRIMARY_METRIC", "eval_f1_toxic")

THRESH_MIN  = 0.05
THRESH_MAX  = 0.95
THRESH_STEP = 0.01
THRESH_OBJECTIVES           = ["f1_toxic", "macro_f1"]
PRIMARY_THRESHOLD_OBJECTIVE = os.environ.get("PRIMARY_THRESHOLD_OBJECTIVE", "f1_toxic")
