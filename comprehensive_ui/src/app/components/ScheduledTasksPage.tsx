...
import { CalendarClock, CheckCircle2, CircleAlert, Loader2, Play, RefreshCw, Save, Settings2 } from "lucide-react";
...
export function ScheduledTasksPage({ adminToken, onAdminUnauthorized }: ScheduledTasksPageProps) {
  ...
  }, [adminToken, onAdminUnauthorized]);
        ...
        <>
          <Card className="p-5 shadow-sm">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2 border-t border-border pt-4">
              <Button onClick={() => void runNow()} disabled={running || latestRun?.status === "running"}>
